...
//#define CUSTOM_MACHINE_NAME "iDJMic CR-10 v2.0.6.1 bug-fix"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 85, 85, 400, 95 } // * Had to change from 80 to 85 to get bed center maybe from SKR mini e3 v1.2 board upgrade idk *
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 30, 25 } // * Had to adjust Z to 30 for DUAL Z-AXIS Motors Mod *
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33, 4, 0 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 81       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
